...
describe :collection_each_slice, shared: true do
  before :each do
    @enum = @subject.new(EnumerableSpecs::Numerous.new(7,6,5,4,3,2,1))
...
describe "Array#each_slice" do
  ...
  it_behaves_like :collection_each_slice, :each_slice
end

describe "Collection#each_slice" do
