module EnumerableSpecs
  class MyArray < Array ;end # added to help me out

  class Numerous < Group
    def initialize(*list)
      super(list.empty? ? [2, 5, 3, 6, 1, 4] : list)
    end
  end
